...
class MovementsControllerTest < ActionController::TestCase
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post :create, movement: { amount: @movement.amount, class: @movement.mov_class, date: @movement.date, description: @movement.description }
    end
  ...
  test "should update movement" do
    patch :update, id: @movement, movement: { amount: @movement.amount, class: @movement.mov_class, date: @movement.date, description: @movement.description }
    assert_redirected_to movement_path(assigns(:movement))
  end
